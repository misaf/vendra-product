...
- `Services\ProductPurchaseQuoter::quote()` owns purchase eligibility and catalog pricing (active category, stock, a price in the currency) and returns a `Data\ProductPurchaseQuote` or an `Enums\ProductPurchaseRefusalEnum` case per request, loading products in one query. Checkout callers reuse it rather than re-deriving the rules; keep cart, order, and API types out of it.
